...
(function (P, X, u) {
    ...
    function Ea(b, a, c, d) {
        ...
        if (a) {
            ...
            E(b) ? a = Ea(b, [], c, d) : pa(b) ? a = new Date(b.getTime()) : pb(b) ? (a = new RegExp(b.source, b.toString().match(/[^\/]*$/)[0]),
    ...
    function tc(b, a, c) {
        ...
        P && e.test(P.name) && (c.debugInfoEnabled = !0,
            ...
            if (a) {
                ...
                !d.history || g && f ? (g || (I = a),
                    c ? q.replace(a) : g ? (c = q,
                        e = a.indexOf("#"),
                        a = -1 === e ? "" : a.substr(e + 1),
                        c.hash = a) : q.href = a) : (t[c ? "replaceState" : "pushState"](e, "", a),
                            h(),
                            N = A);
                return m
            }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, r, S, K, n, D, H, v, A) {
                ...
                function g(a, c, d, e) {
                    ...
                    for (p = h.length; q < p;)
                        l = D[h[q++]],
                            ...
                            f = h[q++],
                            c ? (c.scope ? (k = a.$new(),
                                F.$$addScopeInfo(C(l), k)) : k = a,
                                r = c.transcludeOnThisElement ? I(a, c.transclude, e, c.elementTranscludeOnThisElement) : !c.templateOnThisElement && e ? e : !e && b ? I(a, b) : null,
            ...
            function W(a, b, c, d, g) {
                ...
                switch (a.nodeType) {
                    case na:
                        ha(b, ya(ta(a)), "E", d, g);
                        for (var k, q, p, n = a.attributes, r = 0, D = n && n.length; r < D; r++) {
                            var S = !1
                                , t = !1;
                            k = n[r];
                            l = k.name;
            ...
            function y(a, d, e, f, g, l, k, p, n) {
                ...
                n = n || {};
                for (var v = -Number.MAX_VALUE, N, H = n.controllerDirectives, ba, I = n.newIsolateScopeDirective, ja = n.templateDirective, wa = n.nonTlbTranscludeDirective, ha = !1, fb = !1, B = n.hasElementTranscludeDirective, w = e.$$element = C(d), L, ca, U, R = f, P, Q = 0, Aa = a.length; Q < Aa; Q++) {
                    L = a[Q];
                    var Pa = L.$$start
                        , $ = L.$$end;
                    Pa && (w = va(d, Pa, $));
                    ...
                    if (v > L.priority)
                        break;
                    if (U = L.scope)
                        L.templateUrl || (J(U) ? (Oa("new/isolated scope", I || N, L, w),
                            I = L) : Oa("new/isolated scope", I, L, w)),
                            N = N || L;
                    ca = L.name;
                    ...
                    if (U = L.transclude)
                        ha = !0,
                            L.$$tlb || (Oa("transclusion", wa, L, w),
                                wa = L),
                            "element" == U ? (B = !0,
                                v = L.priority,
                                U = w,
                                w = e.$$element = C(X.createComment(" " + ca + ": " + e[ca] + " ")),
                                d = w[0],
                                V(g, Za.call(U, 0), d),
                                R = F(U, f, v, l && l.name, {
                    ...
                    L.terminal && (A.terminal = !0,
                        v = Math.max(v, L.priority))
                }
                A.scope = N && !0 === N.scope;
            ...
            function M(a, b, c, d, e, f, g, h) {
                ...
                return function (a, b, c, d, e) {
                    a = e;
                    b.$$destroyed || (l ? l.push(b, c, d, a) : (k.transcludeOnThisElement && (a = I(b, k.transclude, e)),
                        k(q, b, c, d, a)))
                }
            }
            function ca(a, b) {
    ...
    function Fe() {
        ...
        this.$get = ["$injector", "$window", function (d, e) {
            ...
            return function (g, h, l, k) {
                ...
                if (l)
                    return l = (E(g) ? g[g.length - 1] : g).prototype,
    ...
    function dc(b, a) {
        ...
        this.$$parseLinkUrl = function (d, e) {
            ...
            var f, g;
            (f = za(b, d)) !== u ? (g = f,
                g = (f = za(a, f)) !== u ? c + (za("/", f) || f) : b + g) : (f = za(c, d)) !== u ? g = c + f : c == d + "/" && (g = c);
            g && this.$$parse(g);
            return !!g
        }
    }
    ...
    function Me() {
        ...
        this.html5Mode = function (b) {
            return Wa(b) ? (a.enabled = b,
                this) : J(b) ? (Wa(b.enabled) && (a.enabled = b.enabled),
    ...
    function Oe() {
        ...
        this.$get = ["$filter", "$sniffer", function (c, d) {
            ...
            function g(a, b) {
                return null == a || null == b ? a === b : "object" === typeof a && (a = gc(a),
            ...
            return function (d, f, g) {
                ...
                switch (typeof d) {
                    case "string":
                        ...
                        var v = g ? a : b;
                        n = v[H];
                        n || (":" === d.charAt(0) && ":" === d.charAt(1) && (D = !0,
                            d = d.substring(2)),
                            g = g ? t : q,
                            n = new hc(g),
                            n = (new ib(n, c, g)).parse(d),
                            n.constant ? n.$$watchDelegate = m : D ? (n = e(n),
                                n.$$watchDelegate = n.literal ? k : l) : n.inputs && (n.$$watchDelegate = h),
                            v[H] = n);
                        return p(n, f);
                    case "function":
                        return p(d, f);
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (e, f, g, h) {
            ...
            l.prototype = {
                ...
                $watchCollection: function (a, b) {
                    ...
                    c.$stateful = !0;
                    var d = this, e, f, h, l = 1 < b.length, k = 0, p = g(a, c), q = [], m = {}, n = !0, t = 0;
    ...
    function Ue() {
        this.$get = ["$window", "$document", function (b, a) {
            ...
            if (l) {
                ...
                !d || k && m || (k = x(f.body.style.webkitTransition),
        ...
        on: function a(c, d, e, f) {
            ...
            if (Fc(c)) {
                ...
                for (var g = 0 <= d.indexOf(" ") ? d.split(" ") : [d], l = g.length; l--;) {
                    ...
                    var k = f[d];
                    k || (f[d] = [],
                        "mouseenter" === d || "mouseleave" === d ? a(c, Pf[d], function (a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                ...
                if (f)
                    "u" === g ? (f = this.text.substring(this.index + 1, this.index + 5),
                        ...
                        this.index += 4,
                        d += String.fromCharCode(parseInt(f, 16))) : d += Yf[g] || g,
                        f = !1;
                else if ("\\" === g)
                    f = !0;
                else {
    ...
    ib.prototype = {
        ...
        primary: function () {
            ...
            this.expect("(") ? (a = this.filterChain(),
                this.consume(")")) : this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.peek().identifier && this.peek().text in mb ? a = mb[this.consume().text] : this.peek().identifier ? a = this.identifier() : this.peek().constant ? a = this.constant() : this.throwError("not a primary expression", this.peek());
                    ...
                    return function (f, g, q, s, r) {
                        ...
                        f.$watch(e.parseAsResourceUrl(h), function (e) {
                            ...
                            e ? (a(e, !0).then(function (a) {
                                ...
                                f.$emit("$includeContentRequested", e)) : (H(),
                                    s.template = null)
                        })
                    }
                }
            ...
            return {
                ...
                link: function (c, d, e, f) {
                    /SVG/.test(d[0].toString()) ? (d.empty(),
                        a(Gc(f.template, X).childNodes)(c, function (a) {
                            d.append(a)
                        }, {
                ...
                link: function (e, g, h, l) {
                    function k(a, c, d, e) {
                        d.$render = function () {
                            ...
                            e.hasOption(a) ? (v.parent() && v.remove(),
                                c.val(a),
                                "" === a && B.prop("selected", !0)) : z(a) && B ? c.val("") : e.renderUnknownOption(a)
                        }
                            ;
                    ...
                    function m(a, c, d) {
                        ...
                        d.$render = function () {
                            ...
                            ;
                        a.$watch(function () {
                            ea(e, d.$viewValue) || (e = qa(d.$viewValue),
                                d.$render())
                        });
                        c.on("change", function () {
                            a.$apply(function () {
                        ...
                        function p() {
                            ...
                            for (B = c.length; x < B; x++) {
                                ...
                                for (E = l.length; A < E; A++)
                                    d = l[A],
                                        (v = u[A + 1]) ? (M = v.element,
                                            v.label !== d.label && (m(O, v.label, !1),
                                                m(O, d.label, !0),
                                                M.text(v.label = d.label),
                                                M.prop("label", v.label)),
                                            v.id !== d.id && M.val(v.id = d.id),
                                            M[0].selected !== d.selected && (M.prop("selected", v.selected = d.selected),
                    ...
                    if (l[1]) {
                        var q = l[0];
                        l = l[1];
                        var t = h.multiple, r = h.ngOptions, w = !1, B, n = !1, D = C(X.createElement("option")), H = C(X.createElement("optgroup")), v = D.clone();
                        h = 0;
